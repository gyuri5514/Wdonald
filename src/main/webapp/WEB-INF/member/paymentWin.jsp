...
<c:if test="${sessionScope.kakaoSession eq null && sessionScope.naverSession eq null && sessionScope.user_email eq null}">
	<script>
         ...
         <fieldset class="fieldset payment-types">
            <div class="form-group row">
               <div class="radio">
                  ...
                  <hr>
                  <br> 현장 결제<br>
                  <br> &nbsp;&nbsp;<input type="radio" id="cash"
                     name="payment_type" value="2"> <label for="cash">&nbsp;현금</label><br>
                  ...
                  &nbsp;&nbsp; <input type="text" disabled="disabled"
                     ...
                     name="cashbillphone" id="cashbillphone"> <br>
                  <br>&nbsp; * 결제를 완료하기 위해 외부 웹 사이트로 안전하게 이동합니다.
               </div>
               <br>
										...
										<table class="table-default table-delivery-address">
											<tbody>
												<tr>
													...
													<td><div><input type="hidden" name="user_address" value="">서울특별시 성북구 성북동1가 109-13 102호</div></td>
												</tr>
											</tbody>
										</table>
									</section>
										...
										<table class="table-default table-cost">
											<tfoot class="total">
												<tr>
													...
													<td><input type="hidden" id="total_price" name="total_price" value="1000"><span>₩ 1,000</span>
											...
											<tbody>
												...
												<tr>
													<th scope="row">배달료:</th>
													<td><input type="hidden" value="" name="delivery_cost"><span>₩ 2,000</span></td>
												</tr>
...
<!--<button type="submit" id="confirmBtn" class="btn btn-red btn-block btn-xl" onclick="submitPayment()" style="display: none;">결제 진행하기</button>
 -->												
											...
											<div class="form-group">
												<a href="#" class="action-secondary action-link "><i class="fa fa-caret-right"></i> &nbsp; <span>주문 재확인</span></a>
											</div>
										</fieldset>
									</section>
								</div>
