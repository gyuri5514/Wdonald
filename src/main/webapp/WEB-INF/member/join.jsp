...
윈도날드는 보다 나은 서비스 제공을 위하여 이용자들이 홈페이지 서비스 이용과정에서 제공하는 개인정보를 WinDonald's Family와 공유할 수 있습니다. 
WinDonald's Family는 윈도날드의 계열회사, 프랜차이즈 및 윈도날드가 고객들에게 제공하는 서비스와 관련하여 윈도날드와 제휴관계에 있는 제휴사를 포함합니다. 
WinDonald's Family의 개인정보 사용은 &lt;개인정보 수집목적 및 이용목적&gt;을 준수합니다. 
