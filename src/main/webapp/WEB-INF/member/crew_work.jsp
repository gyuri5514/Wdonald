			...
			<div class="inner">
				...
				<div class="managerTbl">
					<table class="tableType01">
						<caption>업무 소개 - 레스토랑 제너럴 매니저, 피플 디벨롭먼트 매니저, 푸드 퀄리티 매니저,
							고객 경험 매니저, 매니저 트레이니</caption>
						<colgroup>
							<col style="width: 25%">
							<col>
						</colgroup>
						<tbody>
							<tr>
								<th scope="row">레스토랑 제너럴 매니저<br>(Restaurant General Manager)
								</th>
								<td>레스토랑에서 품질, 서비스 및 청결에 관한 스탠다드가 준수되도록 운영합니다.<br>레스토랑에서
									구체적인 책임을 가진 디파트먼트 매니저 팀을 이끌고 있으며,<br>레스토랑의 중요한 여러 가지 기능과
									시스템을 관리합니다.
								</td>
							</tr>
							<tr>
								<th scope="row">피플 디벨롭먼트 매니저<br>(People Development Manager)
								</th>
								<td>적합한 크루를 채용, 교육 및 스케줄링 할 책임이 있습니다.<br>크루의 레스토랑 입사
									시부터 잘 정착하게 하고 근무하는 동안 관리합니다.
								</td>
							</tr>
							<tr>
								<th scope="row">푸드 퀄리티 매니저<br>(Food Quality Manager)
								</th>
								<td>레스토랑 내의 프로덕션 시스템을 관리합니다.<br>이 책임은 고객에게 최고 품질의 제품
									제공을 위한 인벤토리와 프로덕션 시스템을 관리합니다.
								</td>
							</tr>
							<tr>
								<th scope="row">고객 경험 매니저<br>(Customer Experience Manager)
								</th>
								<td>고객에게 탁월한 고객 서비스 경험을 제공할 책임이 있으며, 세일즈 촉진 활동 및 서비스 프로그램을
									관리합니다.</td>
							</tr>
							<tr>
								<th scope="row">매니저 트레이니 (Manager Trainee)</th>
								<td>공개 채용 절차를 통해 입사하는 직급으로, 체계적인 매니저 교육을 통하여 성장의 기회를 갖게
									됩니다.</td>
							</tr>
						</tbody>
					</table>
