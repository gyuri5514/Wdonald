		...
		<div class="contArea">
			<div class="inner type02">
				<ul class="tabType01">
					...
					<li><a href="crew_recruit.do" role="button" aria-selected="true">인재채용</a></li>
				</ul>
				<div class="careerIntro">
					<p>
						변화를 만나는 곳, 변화를 만드는 곳<br>한국윈도날드의 최신 채용정보를 확인하세요.
					</p>
				</div>
				<div class="careersWrap">
					<div>
						...
						<p>
							윈도날드의 시간제(Part Time) 근무자를 우리는 크루(Crew) 라고 부릅니다.<br>즐거운 일터에서
					...
					<div>
						...
						<p>
							...
							윈도날드가 되기를 희망합니다. 늘 현명한 선택으로 성공을 창조해 온 윈도날드, 이곳에서 당신의 소중한 꿈을 펼쳐보세요
							!
						</p>
